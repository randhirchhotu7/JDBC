...
// Note : from code c1 to c6 only Statement Interface used with executeUpdate() method !! //
// But in this I am going to use Prepared Statement along with placeholder with executeUpdate() //
